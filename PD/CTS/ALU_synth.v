...
(* top =  1  *)
(* src = "ALU.v:1.1-23.10" *)
module ALU(A, B, opcode, clk, result, carry_out);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire _112_;
  (* force_downto = 32'd1 *)
  (* src = "ALU.v:0.0-0.0|ALU.v:11.9-20.16|/usr/local/bin/../share/yosys/techmap.v:575.21-575.22" *)
  wire _113_;
  (* force_downto = 32'd1 *)
  (* src = "ALU.v:0.0-0.0|ALU.v:11.9-20.16|/usr/local/bin/../share/yosys/techmap.v:575.21-575.22" *)
  wire [3:0] _114_;
  ...
  sky130_fd_sc_hd__o221ai_1 _143_ (
    .A1(A[3]),
    .A2(_036_),
    .B1(_037_),
    .B2(A[2]),
  ...
  sky130_fd_sc_hd__o21ba_1 _175_ (
    .A1(B[1]),
    .A2(_075_),
    .B1_N(_091_),
    .X(_092_)
  ...
  sky130_fd_sc_hd__a211o_1 _178_ (
    .A1(_037_),
    .A2(_059_),
    .B1(_094_),
    .C1(opcode[2]),
  ...
  sky130_fd_sc_hd__or3b_1 _179_ (
    .A(opcode[2]),
    .B(opcode[0]),
    .C_N(opcode[1]),
    .X(_096_)
  );
  sky130_fd_sc_hd__or3b_1 _180_ (
    .A(opcode[1]),
    .B(opcode[0]),
    .C_N(opcode[2]),
    .X(_097_)
  ...
  sky130_fd_sc_hd__nand3b_1 _182_ (
    .A_N(opcode[0]),
    .B(opcode[1]),
    .C(opcode[2]),
    .Y(_099_)
  ...
  sky130_fd_sc_hd__o22ai_1 _185_ (
    .A1(A[0]),
    .A2(_099_),
    .B1(_100_),
    .B2(_090_),
  ...
  sky130_fd_sc_hd__o221ai_1 _209_ (
    .A1(_041_),
    .A2(_097_),
    .B1(_099_),
    .B2(A[2]),
  ...
  sky130_fd_sc_hd__o22ai_1 _217_ (
    .A1(A[3]),
    .A2(B[3]),
    .B1(_101_),
    .B2(_017_),
